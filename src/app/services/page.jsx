      ...
      <div>
        ...
        >
          ...
          <p className="text-accent-foreground mt-5 sm:w-2/3 mx-auto">
            I offer end-to-end web development services, creating responsive and
            dynamic websites tailored to your needs. From front-end design to
            back-end functionality, I deliver scalable and user-friendly digital
            solutions.
          </p>
        </MotionDiv>
